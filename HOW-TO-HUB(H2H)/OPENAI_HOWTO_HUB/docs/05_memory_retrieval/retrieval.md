...
Fetched URL: https://developers.openai.com/api/docs/guides/retrieval
Fetched at: 2026-05-22T09:28:58.070108+00:00
...
Create vector store with filespython
...
RegionDate rangeFilenamesExclude filenamesComplex RegionFilter for a region
...
Date rangeFilter for a date range
...
FilenamesFilter to match any of a set of filenames
...
Exclude filenamesFilter to exclude drafts by filename
...
ComplexFilter for top secret projects with certain names in english
...
CreateRetrieveUpdateDeleteList CreateCreate vector storepython
...
RetrieveRetrieve vector storepython
...
UpdateUpdate vector storepython
...
DeleteDelete vector storepython
...
CreateUploadRetrieveUpdateDeleteList CreateCreate vector store filepython
...
UploadUpload vector store filepython
...
RetrieveRetrieve vector store filepython
...
UpdateUpdate vector store filepython
...
DeleteDelete vector store filepython
...
ListList vector store filespython
...
CreateRetrieveCancelList CreateBatch create operationpython
...
RetrieveBatch retrieve operationpython
...
CancelBatch cancel operationpython
...
ListBatch list operationpython
...
Create vector store file with attributespython
...
Set expiration policy for vector storepython
...
Perform search query to get resultspython
...
Synthesize a response based on resultspython
...
Sample result formatting functionpython
