...
Source: https://developers.openai.com/api/docs/overview
Fetched URL: https://developers.openai.com/api/docs
Fetched at: 2026-05-22T09:28:49.092393+00:00

---

OpenAI API Platform Documentation

 [Home](https://developers.openai.com/) [API](https://developers.openai.com/api) [Docs](https://developers.openai.com/api/docs) [Guides and concepts for the OpenAI API](https://developers.openai.com/api/docs) [API reference](https://developers.openai.com/api/reference/overview) [Endpoints, parameters, and responses](https://developers.openai.com/api/reference/overview) [Codex](https://developers.openai.com/codex) [Docs](https://developers.openai.com/codex) [Guides, concepts, and product docs for Codex](https://developers.openai.com/codex) [Use cases](https://developers.openai.com/codex/use-cases) [Example workflows and tasks teams hand to Codex](https://developers.openai.com/codex/use-cases) [ChatGPT](https://developers.openai.com/chatgpt) [Apps SDK](https://developers.openai.com/apps-sdk) [Build apps to extend ChatGPT](https://developers.openai.com/apps-sdk) [Commerce](https://developers.openai.com/commerce) [Build commerce flows in ChatGPT](https://developers.openai.com/commerce) [Ads](https://developers.openai.com/ads) [Publish and measure ads in ChatGPT](https://developers.openai.com/ads) [Resources](https://developers.openai.com/learn) [Showcase](https://developers.openai.com/showcase) [Demo apps to get inspired](https://developers.openai.com/showcase) [Blog](https://developers.openai.com/blog) [Learnings and experiences from developers](https://developers.openai.com/blog) [Cookbook](https://developers.openai.com/cookbook) [Notebook examples for building with OpenAI models](https://developers.openai.com/cookbook) [Learn](https://developers.openai.com/learn) [Docs, videos, and demo apps for building with OpenAI](https://developers.openai.com/learn) [Community](https://developers.openai.com/community) [Programs, meetups, and support for builders](https://developers.openai.com/community) Start searching [API Dashboard](https://platform.openai.com/login)
...
[Get started](https://developers.openai.com/api/docs/quickstart)[Create API key](https://platform.openai.com/api-keys)javascript
...
[Install the plugin](https://developers.openai.com/learn/developers-codex-plugin)

## Build paths

### [Responses API](https://developers.openai.com/api/docs/guides/text)

[Make direct model requests for text, structured output, tools, and multimodal workflows.](https://developers.openai.com/api/docs/guides/text)

[Start with Responses](https://developers.openai.com/api/docs/guides/text)

### [Agents SDK](https://developers.openai.com/api/docs/guides/agents/quickstart)

[Build code-first agents that orchestrate tools, handoffs, approvals, tracing, and container-based execution.](https://developers.openai.com/api/docs/guides/agents/quickstart)

[Start with the Agents SDK](https://developers.openai.com/api/docs/guides/agents/quickstart)

## Models

Start with gpt-5.5 for complex reasoning and coding, or choose gpt-5.4-mini and gpt-5.4-nano for lower-latency, lower-cost workloads.[View all](https://developers.openai.com/api/docs/models)[GPT-5.5](https://developers.openai.com/api/docs/models/gpt-5.5)[New](https://developers.openai.com/api/docs/models/gpt-5.5)[A new class of intelligence for coding and professional work.](https://developers.openai.com/api/docs/models/gpt-5.5)[GPT-5.4](https://developers.openai.com/api/docs/models/gpt-5.4)[A more affordable model for coding and professional work.](https://developers.openai.com/api/docs/models/gpt-5.4)[GPT-5.4 mini](https://developers.openai.com/api/docs/models/gpt-5.4-mini)[Our strongest mini model yet for coding, computer use, and subagents](https://developers.openai.com/api/docs/models/gpt-5.4-mini)

## Start building

[Read and generate text](https://developers.openai.com/api/docs/guides/text)[Use the API to prompt a model and generate text](https://developers.openai.com/api/docs/guides/text)[Use a model's vision capabilities](https://developers.openai.com/api/docs/guides/images-vision)[Allow models to see and analyze images in your application](https://developers.openai.com/api/docs/guides/images-vision)[Generate images as output](https://developers.openai.com/api/docs/guides/image-generation)[Create images with GPT Image 2](https://developers.openai.com/api/docs/guides/image-generation)[Build apps with audio](https://developers.openai.com/api/docs/guides/audio)[Analyze, transcribe, and generate audio with API endpoints](https://developers.openai.com/api/docs/guides/audio)[Build agentic applications](https://developers.openai.com/api/docs/guides/agents)[Use the API to build agents that use tools and computers](https://developers.openai.com/api/docs/guides/agents)[Achieve complex tasks with reasoning](https://developers.openai.com/api/docs/guides/reasoning)[Use reasoning models to carry out complex tasks](https://developers.openai.com/api/docs/guides/reasoning)[Get structured data from models](https://developers.openai.com/api/docs/guides/structured-outputs)[Use Structured Outputs to get model responses that adhere to a JSON schema](https://developers.openai.com/api/docs/guides/structured-outputs)[Tailor to your use case](https://developers.openai.com/api/docs/guides/model-optimization)[Adjust our models to perform specifically for your use case with fine-tuning, evals, and distillation](https://developers.openai.com/api/docs/guides/model-optimization)[Help center](https://help.openai.com)[Frequently asked account and billing questions](https://help.openai.com)[Developer forum](https://community.openai.com/)[Discuss topics with other developers](https://community.openai.com/)[Cookbook](https://developers.openai.com/cookbook)[Open-source collection of examples and guides](https://developers.openai.com/cookbook)[Status](https://status.openai.com)[Check the status of OpenAI services](https://status.openai.com)
