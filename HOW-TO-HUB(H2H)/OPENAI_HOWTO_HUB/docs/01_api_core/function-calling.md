...
Fetched URL: https://developers.openai.com/api/docs/guides/function-calling
Fetched at: 2026-05-22T09:28:51.797705+00:00
...
Define objects to represent function schemapython
...
Strict mode enabledStrict mode disabled Strict mode enabled
...
- Some features of JSON schema are not supported. (See [supported schemas](https://developers.openai.com/api/docs/guides/structured-outputs?context=with_parse#supported-schemas).)
...
- Schemas are cached for performance, and are not eligible for [zero data retention](https://developers.openai.com/api/docs/models#how-we-use-your-data).
