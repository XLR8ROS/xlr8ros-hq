...
Fetched URL: https://developers.openai.com/api/docs/guides/file-inputs
Fetched at: 2026-05-22T09:28:52.335379+00:00
...
Chat Completions does not support file URLs. Use the [Responses API](https://developers.openai.com/api/docs/guides/file-inputs?api-mode=responses#file-urls) for this option.
...
Send a Base64-encoded filecurl
...
PDF filesPDF files (`.pdf`)`application/pdf`
...
SpreadsheetsCSV / TSV / IIF (`.csv`, `.tsv`, `.iif`), Google Sheets`text/csv`, `application/csv`, `text/tsv`, `text/x-iif`, `application/x-iif`, `application/vnd.google-apps.spreadsheet`

Rich documentsWord/ODT/RTF docs (`.doc`, `.docx`, `.dot`, `.odt`, `.rtf`), Pages, Google Docs`application/vnd.openxmlformats-officedocument.wordprocessingml.document`, `application/msword`, `application/rtf`, `text/rtf`, `application/vnd.oasis.opendocument.text`, `application/vnd.apple.pages`, `application/vnd.google-apps.document`, `application/vnd.apple.iwork`

PresentationsPowerPoint slides (`.pot`, `.ppa`, `.pps`, `.ppt`, `.pptx`, `.pwz`, `.wiz`), Keynote, Google Slides`application/vnd.openxmlformats-officedocument.presentationml.presentation`, `application/vnd.ms-powerpoint`, `application/vnd.apple.keynote`, `application/vnd.google-apps.presentation`, `application/vnd.apple.iwork`
...
[Experiment with file inputs in the Playground](https://platform.openai.com/chat/edit)

[Use the Playground to develop and iterate on prompts with file inputs.](https://platform.openai.com/chat/edit)

[Full API reference](https://developers.openai.com/api/docs/api-reference/responses)

[Check out the API reference for more options.](https://developers.openai.com/api/docs/api-reference/responses)

[Use File Search for large corpora](https://developers.openai.com/api/docs/guides/tools-file-search)
...
[Use Hosted Shell for deep spreadsheet analysis](https://developers.openai.com/api/docs/guides/tools-shell#hosted-shell-quickstart)
