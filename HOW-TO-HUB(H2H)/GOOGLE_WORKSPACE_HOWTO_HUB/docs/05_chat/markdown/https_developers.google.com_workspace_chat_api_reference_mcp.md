...
# MCP Reference: chatmcp.googleapis.com <span slot="popout-heading"> Stay organized with collections </span> <span slot="popout-contents"> Save and categorize content based on your preferences. </span>
...
<div id="/workspace/chat/api/reference/mcp/index" class="section">
...
The Chat MCP API MCP server has the following global MCP endpoint:

- https://chatmcp.googleapis.com/mcp/v1

The Chat MCP API MCP server offers the following MCP toolset endpoint:
...
The chatmcp.googleapis.com MCP server has the following toolset:
...
<td>/mcp/v1</td>
<td>Tools for Google Chat.</td>
<td><code translate="no" dir="ltr"> </code>
<ul>
<li><a href="/workspace/chat/api/reference/mcp/tools_list/list_messages">list_messages</a></li>
<li><a href="/workspace/chat/api/reference/mcp/tools_list/search_conversations">search_conversations</a></li>
<li><a href="/workspace/chat/api/reference/mcp/tools_list/search_messages">search_messages</a></li>
<li><a href="/workspace/chat/api/reference/mcp/tools_list/send_message">send_message</a></li>
</ul></td>
</tr>
</tbody>
</table>
