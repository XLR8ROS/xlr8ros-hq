...
<div id="/workspace/calendar/api/v3/reference/mcp/tools_list/update_event" class="section">
...
<div id="Input.Schema.UpdateEventRequest" class="section">
...
<p>Required. The ID of the event to update.</p></td>
</tr>
<tr id="Input.Schema.FIELDS.field_section_1">
<td><code translate="no" dir="ltr">addedAttendeeEmails[]</code></td>
<td><p><code class="apitype" translate="no" dir="ltr">string</code></p>
<p>Optional. The additional attendees of the event, as email addresses.</p></td>
</tr>
<tr id="Input.Schema.FIELDS.field_section_2">
<td><code translate="no" dir="ltr">removedAttendeeEmails[]</code></td>
<td><p><code class="apitype" translate="no" dir="ltr">string</code></p>
<p>Optional. The attendees of the event to remove, as email addresses.</p></td>
</tr>
...
<p>Optional. Reminders defined for this event, overriding any existing reminders and the default reminders for the calendar. If set, this will replace all existing reminders on the event. If not set, reminders will not be updated.</p></td>
</tr>
...
<td><p><code class="apitype" translate="no" dir="ltr">string</code></p>
<p>Optional. The calendar ID of the event to update. The default is the user's primary calendar.</p></td>
</tr>
<tr id="Input.Schema.FIELDS.ONEOF_1" class="alt">
<td colspan="2"><p>Union field <code translate="no" dir="ltr">_summary</code>.</p>
<p><code translate="no" dir="ltr">_summary</code> can be only one of the following:</p></td>
</tr>
<tr id="Input.Schema.FIELDS.field_section_5">
<td><code translate="no" dir="ltr">summary</code></td>
<td><p><code class="apitype" translate="no" dir="ltr">string</code></p>
<p>Optional. The new title of the event. Will not be updated if not set.</p></td>
</tr>
...
<td><p><code class="apitype" translate="no" dir="ltr">string</code></p>
<p>Optional. The new description of the event. Will not be updated if not set.</p></td>
</tr>
...
<td><p><code class="apitype" translate="no" dir="ltr">string</code></p>
<p>Optional. The new location of the event. Will not be updated if not set.</p></td>
</tr>
...
<td><p><code class="apitype" translate="no" dir="ltr">string</code></p>
<p>Optional. The new start time of the event formatted as per ISO 8601. Will not be updated if not set.</p></td>
</tr>
...
<td><p><code class="apitype" translate="no" dir="ltr">string</code></p>
<p>Optional. The new end time of the event formatted as per ISO 8601. Will not be updated if not set.</p></td>
</tr>
...
<p>Optional. Allows to create or update a Google Meet url for the event. By default, no Google Meet url is created or updated. No Google Meet url is created or updated if Meet is disabled for the user, but the event update will succeed.</p></td>
</tr>
...
<td><p><code class="apitype" translate="no" dir="ltr">string</code></p>
<p>Optional. New visibility of the event. Possible values are:</p>
<ul>
...
<td><p><code class="apitype" translate="no" dir="ltr">string</code></p>
<p>Optional. New color ID of the event. Will not be updated if not set. Event color ID (string <code translate="no" dir="ltr">1</code>-<code translate="no" dir="ltr">11</code>):</p>
<ul>
<li>1: Lavender</li>
<li>2: Sage</li>
<li>3: Grape</li>
...
<tr id="Input.Schema.FIELDS.ONEOF_10" class="alt">
