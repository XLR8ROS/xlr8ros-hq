...
<div id="/workspace/calendar/api/v3/reference/mcp/tools_list/respond_to_event" class="section">
...
<div id="Input.Schema.RespondToEventRequest" class="section">
...
<p>Required. The ID of the event to respond to.</p></td>
</tr>
<tr id="Input.Schema.FIELDS.field_section_1">
<td><code translate="no" dir="ltr">responseStatus</code></td>
<td><p><code class="apitype" translate="no" dir="ltr">string</code></p>
<p>Required. The new user's response status of the event. Possible values are:</p>
<ul>
...
<td><p><code class="apitype" translate="no" dir="ltr">string</code></p>
<p>Optional. The calendar ID of the event to respond to. The default is the user's primary calendar.</p></td>
</tr>
...
<td colspan="2"><p>Union field <code translate="no" dir="ltr">_response_comment</code>.</p>
<p><code translate="no" dir="ltr">_response_comment</code> can be only one of the following:</p></td>
</tr>
<tr id="Input.Schema.FIELDS.field_section_4">
<td><code translate="no" dir="ltr">responseComment</code></td>
<td><p><code class="apitype" translate="no" dir="ltr">string</code></p>
<p>Optional. The user's comment attached to the response.</p></td>
</tr>
</tbody>
</table>
