...
<div id="/workspace/calendar/api/v3/reference/mcp/tools_list/get_event" class="section">
...
The following sample demonstrate how to use `curl` to invoke the `get_event` MCP tool.
...
<div id="Input.Schema.GetEventRequest" class="section">
...
<p>Required. The ID of the event to get.</p></td>
</tr>
...
<td><p><code class="apitype" translate="no" dir="ltr">string</code></p>
<p>Optional. The calendar ID to get the event from. The default is the user's primary calendar.</p></td>
</tr>
</tbody>
</table>
