...
# Configure the Calendar MCP server <span slot="popout-heading"> Stay organized with collections </span> <span slot="popout-contents"> Save and categorize content based on your preferences. </span>
...
<a href="https://console.cloud.google.com/flows/enableapi?apiid=calendar-json.googleapis.com" class="button button-primary" target="console">Enable the APIs</a>
...
<a href="https://console.cloud.google.com/flows/enableapi?apiid=calendarmcp.googleapis.com" class="button button-primary" target="console">Enable the MCP services</a>
...
- **Authentication**: The Google Calendar remote MCP server uses OAuth 2.0. For details, see [Learn about authentication and authorization](/workspace/guides/auth-overview).
