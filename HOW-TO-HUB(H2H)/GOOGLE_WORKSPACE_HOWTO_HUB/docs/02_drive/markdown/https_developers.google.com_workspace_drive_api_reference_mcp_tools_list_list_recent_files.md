...
<div id="/workspace/drive/api/reference/mcp/tools_list/list_recent_files" class="section">
...
<div id="Input.Schema.ListFilesRequest" class="section">
...
<p>The sort order for the files.</p></td>
</tr>
...
<td><p><code class="apitype" translate="no" dir="ltr">string</code></p>
<p>The page token to use for pagination.</p></td>
</tr>
...
<p>The maximum number of files to return.</p></td>
</tr>
<tr id="Input.Schema.FIELDS.ONEOF_3" class="alt">
<td colspan="2"><p>Union field <code translate="no" dir="ltr">_exclude_content_snippets</code>.</p>
<p><code translate="no" dir="ltr">_exclude_content_snippets</code> can be only one of the following:</p></td>
</tr>
<tr id="Input.Schema.FIELDS.field_section_3">
<td><code translate="no" dir="ltr">excludeContentSnippets</code></td>
<td><p><code class="apitype" translate="no" dir="ltr">boolean</code></p>
<p>If true, the content snippet will be excluded from the response.</p></td>
</tr>
</tbody>
</table>
...
<div id="Output.Schema.ListFilesResponse" class="section">
...
<td><p><code class="apitype" translate="no" dir="ltr">object (</code><a href="/workspace/drive/api/reference/mcp/tools_list/create_file#Output.Schema.File"><code translate="no" dir="ltr">File</code></a><code class="apitype" translate="no" dir="ltr">)</code></p>
<p>The list of files.</p></td>
</tr>
...
<tr id="Output.Schema.FIELDS_1.ONEOF_5" class="alt">
...
<tr id="Output.Schema.FIELDS_1.ONEOF_6" class="alt">
...
<tr id="Output.Schema.FIELDS_1.field_section_9">
...
<tr id="Output.Schema.FIELDS_1.ONEOF_7" class="alt">
...
<tr id="Output.Schema.FIELDS_1.field_section_10">
<td><code translate="no" dir="ltr">createdTime</code></td>
<td><p><code class="apitype" translate="no" dir="ltr">string (</code><a href="https://protobuf.dev/reference/protobuf/google.protobuf/#timestamp"><code translate="no" dir="ltr">Timestamp</code></a><code class="apitype" translate="no" dir="ltr"> format)</code></p>
<p>The time that the file was created.</p>
<p>Uses RFC 3339, where generated output will always be Z-normalized and use 0, 3, 6 or 9 fractional digits. Offsets other than "Z" are also accepted. Examples: <code translate="no" dir="ltr">"2014-10-02T15:01:23Z"</code>, <code translate="no" dir="ltr">"2014-10-02T15:01:23.045123456Z"</code> or <code translate="no" dir="ltr">"2014-10-02T15:01:23+05:30"</code>.</p></td>
</tr>
<tr id="Output.Schema.FIELDS_1.ONEOF_8" class="alt">
...
<tr id="Output.Schema.FIELDS_1.field_section_13">
