...
<div id="/workspace/gmail/api/reference/mcp/tools_list/label_message" class="section">
...
<div id="Input.Schema.LabelMessageRequest" class="section">
...
<p>Required. The ID of the message to add the labels to.</p></td>
</tr>
<tr id="Input.Schema.FIELDS.field_section_1">
<td><code translate="no" dir="ltr">labelIds[]</code></td>
<td><p><code class="apitype" translate="no" dir="ltr">string</code></p>
<p>Required. The IDs of the labels to add. Can be a system label ID (e.g., 'INBOX', 'TRASH', 'SPAM', 'STARRED', 'UNREAD', 'IMPORTANT') or a user-defined label ID. The tool accepts <code translate="no" dir="ltr">label_ids</code> and not label names. Use the list_labels tool to get the corresponding label id to a display name for user-defined labels.</p></td>
</tr>
</tbody>
</table>
