...
<div id="/workspace/gmail/api/reference/mcp/tools_list/unlabel_thread" class="section">
...
<div id="Input.Schema.UnlabelThreadRequest" class="section">
...
<p>Required. The unique identifier of the thread to remove labels from.</p></td>
</tr>
<tr id="Input.Schema.FIELDS.field_section_1">
<td><code translate="no" dir="ltr">labelIds[]</code></td>
<td><p><code class="apitype" translate="no" dir="ltr">string</code></p>
<p>Required. The unique identifiers of the labels to remove. Can be a system label ID (e.g., 'INBOX', 'TRASH', 'SPAM', 'STARRED', 'UNREAD', 'IMPORTANT') or a user-defined label ID. The tool accepts <code translate="no" dir="ltr">label_ids</code> and not label names. Use the list_labels tool to get the corresponding label id to a display name for user-defined labels.</p></td>
</tr>
</tbody>
</table>
