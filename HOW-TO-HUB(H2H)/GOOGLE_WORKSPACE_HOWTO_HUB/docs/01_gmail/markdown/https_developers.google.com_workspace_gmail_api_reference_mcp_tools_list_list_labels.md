...
<div id="/workspace/gmail/api/reference/mcp/tools_list/list_labels" class="section">
...
<div id="Input.Schema.ListLabelsRequest" class="section">
...
<p>Optional. The maximum number of labels to return.</p></td>
</tr>
...
<p>Optional. Page token to retrieve a specific page of results in the list.</p></td>
</tr>
</tbody>
</table>
...
<div id="Output.Schema.ListLabelsResponse" class="section">
...
<td><p><code class="apitype" translate="no" dir="ltr">object (</code><a href="/workspace/gmail/api/reference/mcp/tools_list/list_labels#Output.Schema.Label"><code translate="no" dir="ltr">Label</code></a><code class="apitype" translate="no" dir="ltr">)</code></p>
<p>List of user labels in the user's account.</p></td>
</tr>
<tr id="Output.Schema.FIELDS.field_section_1">
<td><code translate="no" dir="ltr">nextPageToken</code></td>
<td><p><code class="apitype" translate="no" dir="ltr">string</code></p>
<p>Token to retrieve the next page of results in the list.</p></td>
</tr>
</tbody>
</table>
